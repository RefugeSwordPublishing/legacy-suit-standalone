...
export default function SettingsHub() {
  ...
  // Plans are bought on the web only. See docs/play-store-handoff.md.
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-2 sm:justify-end">
              {nativeApp ? (
                <p className="text-xs text-muted-foreground sm:text-right">
                  Plans are managed on the web. Open app.guildwright.app in a browser to choose or change your plan.
                </p>
              ) : isPro ? (
      ...
      {/* Play requires an in-app deletion path on every platform, so this is not mobile-only. */}
      <div>
        <h2 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">Your account</h2>
        <DeleteAccountCard />
      </div>
